...
//___________________________________________________________________________//
  ...
  ClaRa.Components.BoundaryConditions.BoundaryGas_pTxi idealGasPressureSink(medium=simCenter.flueGasModel, p_const=100000) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={52,-36})));
  ...
  Modelica.Blocks.Sources.Ramp Temperature1(
    ...
    offset=273.15 + 250)
        ...
        rotation=0,
        origin={-70,-50})));
  ClaRa_Obsolete.Components.FlueGasCleaning.Denitrification.Denitrification_L1_NH3port deNOx(redeclare model HeatTransfer = ClaRa.Basics.ControlVolumes.Fundamentals.HeatTransport.Generic_HT.Adiabat_L2) annotation (Placement(transformation(extent={{4,-46},{24,-26}})));
  ClaRa.Components.BoundaryConditions.BoundaryGas_Txim_flow idealGasFlowSource_XRG2(
    ...
    medium=simCenter.flueGasModel,
    T_const=523.15,
    xi_const={0/9,0/9,0/9,0/9,0/9,0/9,0/9,0/9,9/9}) annotation (Placement(transformation(extent={{-32,-14},{-12,6}})));
