...
//___________________________________________________________________________//
  ...
  ClaRa.Components.BoundaryConditions.BoundaryGas_Txim_flow idealGasFlowSource_XRG(
    m_flow_const=10,
    variable_m_flow=true,
    variable_T=true,
    xi_const={0.01,0,0.73,0,0.065,0.036,0,0.13,0.0}) annotation (Placement(transformation(extent={{-40,-28},{-20,-8}})));
  ClaRa.Components.BoundaryConditions.BoundaryGas_pTxi idealGasPressureSink(p_const=100000, xi_const={0.0,0,0.73,0,0.065,0.036,0,0.13,0.0}) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={70,-18})));
  ...
  Modelica.Blocks.Sources.Ramp Temperature(
    ...
    offset=273.15 + 150)
        ...
        rotation=0,
        origin={-70,-30})));
  ClaRa_Obsolete.Components.FlueGasCleaning.E_Filter.E_Filter_L2_simple_old e_Filter_dynamic(separationRate=0.9995, xi_start={0.0,0,0.73,0,0.065,0.036,0,0.13,0.0}) annotation (Placement(transformation(extent={{-4,-28},{16,-8}})));
