...
//___________________________________________________________________________//
  ...
  ClaRa.Components.BoundaryConditions.BoundaryGas_pTxi idealGasPressureSink(                                             p_const=100000, xi_const={1/9,1/9,1/9,1/9,1/9,1/9,1/9,1/9,1/9})
  ...
  Modelica.Blocks.Sources.Ramp Temperature(
    ...
    offset=273.15 + 150)
        ...
        rotation=0,
        origin={-70,-30})));
  ClaRa_Obsolete.Components.FlueGasCleaning.E_Filter.E_Filter_L2_empirical_old e_Filter_dynamic(
...
PURPOSE:
>>Tester for the E_Filter_empirical component"),
                                Text(
          extent={{-100,60},{-20,50}},
          lineColor={0,128,0},
          fontSize=34,
