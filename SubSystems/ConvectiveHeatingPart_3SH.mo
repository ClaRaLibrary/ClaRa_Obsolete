...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.Length diameter_i_SH1=0.05 "Inner diameter of the SH1 pipes"
                                      annotation(Dialog(tab= "Superheater 1", group="Geometry"));
  parameter Modelica.SIunits.Length diameter_o_SH1=0.06 "Inner diameter of the SH1 pipes"
                                      annotation(Dialog(tab= "Superheater 1", group="Geometry"));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.SpecificEnthalpy h_nomSH1_out=3050e3 "Nominal specific enthalpy at SH1 outlet"
                                              annotation(Dialog(tab= "Superheater 1", group="Nominal Values"));
  parameter Modelica.SIunits.Pressure Delta_p_nomSH1=2e5 "Nominal pressure at SH1 outlet"
                                     annotation(Dialog(tab= "Superheater 1", group="Nominal Values"));
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.SpecificEnthalpy h_nomSH2_in=3000e3 "Nominal specific enthalpy at inlet of SH2"
                                                annotation(Dialog(tab= "Superheater 2", group="Nominal Values"));
  parameter Modelica.SIunits.Pressure p_nomSH2_out=300e5 "Nominal pressure at SH2 outlet"
                                     annotation(Dialog(tab= "Superheater 2", group="Nominal Values"));
  parameter Modelica.SIunits.SpecificEnthalpy h_nomSH2_out= 3300e3 "Nominal specific enthalpy at SH2 outlet"
                                              annotation(Dialog(tab= "Superheater 2", group="Nominal Values"));
